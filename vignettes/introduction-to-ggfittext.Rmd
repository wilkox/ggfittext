...
argument (a `grid::unit()` object, defaulting to 40 mm). Likewise, you can use
either `ymin` and `ymax` or `y` and `height`. The `x` and `y` aesthetics can be
useful when using a discrete axis.
