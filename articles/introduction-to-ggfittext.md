...
![](introduction-to-ggfittext_files/figure-html/unnamed-chunk-1-1.png)

As with
[`geom_text()`](https://ggplot2.tidyverse.org/reference/geom_text.html),
the position of the text is set by the `x` and `y` aesthetics.
[`geom_fit_text()`](https://wilkox.org/ggfittext/reference/geom_fit_text.md)
tries to infer the width and height of the box in which the text is
allowed to fit, and shrinks down any text that is too big.
...
![](introduction-to-ggfittext_files/figure-html/unnamed-chunk-2-1.png)
...
![](introduction-to-ggfittext_files/figure-html/unnamed-chunk-3-1.png)
...
![](introduction-to-ggfittext_files/figure-html/unnamed-chunk-4-1.png)

## Bar plots

ggfittext also provides a geom
...
[`grid::unit()`](https://rdrr.io/r/grid/unit.html) objects. The
