...
- [`altitudes`](https://wilkox.org/ggfittext/dev/reference/altitudes.md)
  : Some craft and their altitudes

- [`animals`](https://wilkox.org/ggfittext/dev/reference/animals.md) :
  Some animals and their attributes

- [`animals_rich`](https://wilkox.org/ggfittext/dev/reference/animals_rich.md)
  : Some animals and their attributes, in rich text

- [`beverages`](https://wilkox.org/ggfittext/dev/reference/beverages.md)
  : The compositions of some espresso-based beverages

- [`beverages_rich`](https://wilkox.org/ggfittext/dev/reference/beverages_rich.md)
...
- [`gold`](https://wilkox.org/ggfittext/dev/reference/gold.md) :
